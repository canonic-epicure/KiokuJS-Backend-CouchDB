Class('KiokuJS.Backend.CouchDB', {
    ...
    continued : {
        ...
        methods : {
            ...
            getSingleEntry  : function (id, rev, needIDandREV) {
                this.getRequest({
                    method          : 'GET',
            ...
            deleteSingleEntry : function (id, rev) {
                this.getRequest({
                    method          : 'DELETE',
                ...
                Joose.A.each(nodesOrIds, function (nodeOrId) {
                    ...
                    CONT.AND(function () {
                        ...
                        if (typeof nodeOrId == 'string') {
                            ...
                            this.getSingleEntry(id, null, true).andThen(function (entry, id, rev) {
                                
                                this.deleteSingleEntry(id, rev).now()
                            })
                            
                        } else
                            this.deleteSingleEntry(nodeOrId.ID, nodeOrId.REV).now()
                    })
                })
